...
train_generator = train_datagen.flow_from_directory('train', target_size=(224,168), batch_size=batch_size, class_mode='binary')
...
test_generator = test_datagen.flow_from_directory('validation', target_size=(224,168), batch_size=1, class_mode='binary')
#x_train, x_test = x_train/255.0, x_test/255.0
#y_train, y_test = keras.utils.to_categorical(y_train), keras.utils.to_categorical(y_test)

model = keras.models.Sequential()

model.add(keras.layers.Conv2D(512,(4,4), padding='same', activation='relu', input_shape=(224,168,3)))
model.add(keras.layers.Conv2D(512,(4,4), activation='relu'))
